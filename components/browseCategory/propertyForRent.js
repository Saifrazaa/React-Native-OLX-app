...
export default class PropertyForRent extends React.Component {
    constructor() {
        super();
        this.state = {
            property: [
    ...
    render() {
        ...
        return (
            <View>
                <Text style={styles.text}>Property for Rent</Text>
                        ...
                        return (
                            <TouchableOpacity>
                                <Card key={index} style={styles.cardStyle}>
                                    <CardItem cardBody>
                                        <View>
                                            <Image style={styles.imageStyle} source={require("../../images/propertyforsale/2.jpg")} />
